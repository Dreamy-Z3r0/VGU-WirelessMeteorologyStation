...
void setup() {
  ...
  RainGauge_setup(RainGauge_InputPin, Alarm_InputPin, RainfallPerTip);
  ...
  BME280_userSettings.Power_Mode = Adafruit_BME280::MODE_FORCED;
  BME280_userSettings.Temperature_Oversampling = Adafruit_BME280::SAMPLING_X16;
  BME280_userSettings.Pressure_Oversampling = Adafruit_BME280::SAMPLING_X16;
  BME280_userSettings.Humidity_Oversampling = Adafruit_BME280::SAMPLING_X16;
...
void loop() {
  if (RainGauge.RainGauge_DailyAlarm) {
    RainGauge.RainGauge_DailyAlarm = false;

    #ifdef DEBUGGING_OVER_SERIAL
    Serial.print("Daily alarm! Precipitation (rainfall): ");
    Serial.print(RainGauge.Rainfall_Data, 4);
    Serial.println(" mm");
    #endif
  }
